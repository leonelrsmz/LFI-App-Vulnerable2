    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Ir a página...</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
            <form method="get">
              <select name="archivo">
                  <option value="contact">Blog</option>
                  <option value="about">About us</option>
                  <option value="single-post">Nuevo post</option>
                  <option value="category">Categorías</option>
              </select>
              <li><input type="submit"></li>
            </form>
             <!-- <li><a href="search-result.html">Inglés</a></li>
